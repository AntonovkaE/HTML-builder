...
В файле **i.js** директории **01-read-file** напишите скрипт выводящий в консоль содержимое файла **text.txt**. 
...
- [ ] Внутри папки ***01-read-file*** находятся 2 файла **i.js** и **text.txt**
